...
EventWrapper.prototype.touchDownEx = function (x, y,pointerId) {
    if (agentEventWrapper == null) {
        return;
    }
    return agentEventWrapper.touchDownEx(x, y,pointerId);
};
EventWrapper.prototype.touchMoveEx = function (x, y,pointerId) {
    if (agentEventWrapper == null) {
        return;
    }
    return agentEventWrapper.touchMoveEx(x, y,pointerId);
};
EventWrapper.prototype.touchUpEx = function (x, y,pointerId) {
    if (agentEventWrapper == null) {
        return;
    }
    return agentEventWrapper.touchUpEx(x, y,pointerId);
};

EventWrapper.prototype.resetAllTouchState = function () {
    if (agentEventWrapper == null) {
        return false;
    }
    return agentEventWrapper.resetAllTouchState();
};
 ...
 * @return {boolean} | true 成功 false 失败
 */
EventWrapper.prototype.performGlobalAction = function ( actionType) {
    if (agentEventWrapper == null) {
        return false;
    }
    return agentEventWrapper.performGlobalAction(actionType);
};
 ...
 * @return {boolean}  true 此手势的所有触摸事件都成功注入 false 失败
 */
 ...
 * @return {boolean}
 */
EventWrapper.prototype.setFocus = function (selectors) {
    if (agentEventWrapper == null) {
        return null;
    }
    return agentEventWrapper.setFocus(selectors.toJSONString());
};
 ...
 * @return {boolean}
 */
EventWrapper.prototype.setFocusNodeInfo = function (uniqueId) {
    if (agentEventWrapper == null) {
        return null;
    }
    return agentEventWrapper.setFocusNodeInfo(uniqueId);
};
 ...
 * @return {string}
 */
EventWrapper.prototype.getCurrentRunningPkg = function () {
    if (agentEventWrapper == null) {
        return null;
    }
    return javaString2string(agentEventWrapper.getCurrentRunningPkg());
};
 ...
 * @return {null|NotificationInfo[]} 代表没有
 */
 ...
 * @return {boolean}
 */
EventWrapper.prototype.setNodeDumpParam = function (data) {
    if (agentEventWrapper == null) {
        return null;
    }
    return agentEventWrapper.setNodeDumpParam(JSON.stringify(data));
};
 ...
 * @return {boolean}
 */
EventWrapper.prototype.setBlockNode = function (blockNode) {
    if (agentEventWrapper == null) {
        return null;
    }
    return agentEventWrapper.setBlockNode(blockNode);
};

 ...
 */
UIWrapper.prototype.isScriptPause = function () {
    if (uiWrapper == null) {
        return false;
    }
    return uiWrapper.isScriptPause();
}
 ...
 * 适配EC 10.0.0+
 */
UIWrapper.prototype.showScriptCtrlFloatView = function () {
    uiWrapper.showScriptCtrlFloatView();
}
 ...
 * 适配EC 10.0.0+
 */
UIWrapper.prototype.closeScriptCtrlFloatView = function () {
    uiWrapper.closeScriptCtrlFloatView();
}
 ...
 */
UIWrapper.prototype.setScriptPause = function (pause, timeout) {
    if (uiWrapper == null) {
        return false;
    }
    uiWrapper.setScriptPause(pause, timeout);
    return uiWrapper.isScriptPause();
}
 ...
 * @return {boolean} true 代表成功，false 代表失败
 */
UIWrapper.prototype.registeFunctionToScript = function (funcName,callback) {
    if (uiWrapper == null) {
        return false;
    }
    return uiWrapper.ui_registeFunctionToScript(funcName,callback);
};
 ...
 * @return {string} 返回的数据
 */
UIWrapper.prototype.callScriptRegisteFunction = function (funcName,data) {
    if (uiWrapper == null) {
        return null;
    }
    return uiWrapper.ui_callScriptRegisteFunction(funcName,data);
};
 ...
 * @return {boolean} true 代表成功，false 代表失败
 */
UIWrapper.prototype.removeAllUIToScriptFunc = function () {
    if (uiWrapper == null) {
        return false;
    }
    return uiWrapper.ui_removeAllUIToScriptFunc();
};
 ...
 */
UIWrapper.prototype.removeAllScriptToUIFunc = function () {
    if (uiWrapper == null) {
        return false;
    }
    return uiWrapper.ui_removeAllScriptToUIFunc();
};
 ...
 * @return {boolean} true 代表成功，false 代表失败
 */
UIWrapper.prototype.removeFunctionToScript = function (funcName) {
    if (uiWrapper == null) {
        return false;
    }
    return uiWrapper.ui_removeFunctionToScript();
};
 ...
 * @return {string} 返回的数据
 */
UIWrapper.prototype.quickCallJs = function (name,jscode) {
    if (uiWrapper == null) {
        return null;
    }
    return uiWrapper.quickCallJs(name,jscode);
};

 ...
 * @return {boolean} | true 成功 false 失败
 */
AcEventWrapper.prototype.performGlobalAction = function ( actionType) {
    if (acEventWrapper == null) {
        return false;
    }
    return acEventWrapper.performGlobalAction(actionType);
};
/**
 * 分割屏幕
 * <Br/>
...
AcEventWrapper.prototype.getCurrentRunningPkg = function () {
    ...
    return javaString2string(acEventWrapper.getCurrentRunningPkg());
};
...
AcEventWrapper.prototype.setNodeDumpParam = function (data) {
    ...
    return acEventWrapper.setNodeDumpParam(JSON.stringify(data));
};
